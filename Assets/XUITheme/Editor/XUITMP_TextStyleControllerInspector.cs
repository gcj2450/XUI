...
namespace XUIEditor
{
    [CustomEditor(typeof(XUITMP_TextStyleController))]
    public class XUITMP_TextStyleControllerInspector : UnityEditor.Editor
    {
        XUITMP_TextStyleController config;

        private void OnEnable()
        {
            config = (XUITMP_TextStyleController)target;
        }
