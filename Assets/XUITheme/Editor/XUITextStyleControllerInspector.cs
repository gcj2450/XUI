...
namespace XUIEditor
{
    [CustomEditor(typeof(XUITextStyleController))]
    public class XUITextStyleControllerInspector : UnityEditor.Editor
    {
        XUITextStyleController config;

        private void OnEnable()
        {
            config = (XUITextStyleController)target;
        }
