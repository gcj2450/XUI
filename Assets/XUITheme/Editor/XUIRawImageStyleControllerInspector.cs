...
namespace XUIEditor
{
    [CustomEditor(typeof(XUIRawImageStyleController))]
    public class XUIRawImageStyleControllerInspector : UnityEditor.Editor
    {
        XUIRawImageStyleController config;

        private void OnEnable()
        {
            config = (XUIRawImageStyleController)target;
        }
